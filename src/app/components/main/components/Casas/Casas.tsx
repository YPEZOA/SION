...
const Casas = () => {
  return (
    <>
      <HeadingAnimation styles="leading-3	mt-10">
        <h1 className="font-thin tracking-[2px] text-3xl md:text-4xl uppercase text-black">
