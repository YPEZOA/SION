...
const MidContent = () => {
  return (
    <div className='min-h-screen'>
      <section
        className='relative flex justify-center h-[600px] bg-no-repeat bg-cover bg-right bg-fixed'
        style={{
          backgroundImage: `url(${danzaImage})`,
        }}
      >
        <article className='absolute bottom-[-20%] bg-white lg:w-9/12 xl:w-8/12 min-h-[280px] py-20 px-24 rounded-[5px] shadow-[0px_0px_10px_rgba(0,0,0,0.3)] border-[2px] border-[#D9D9D9]'>
          <ElementDelay>
